...
면역관문억제제의 효과를 모델링하고 대상자들의 특성을 통계 분석한 프로젝트 입니다. 보험심사평가원의 수주를 받아 대한항암협회 교수님들과의 협업을 통해 진행이 되었습니다. T-test와 Chi-square test같은 통계 분석에서부터 Logistic Regression과 Cox-Proportional Hazard Regression, Kaplan Meier 등의 survival analysis를 통한 모델링을 통해 새로운 치료제의 효능에 대해 입증하였습니다.
