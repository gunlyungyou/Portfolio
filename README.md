...
신문기사와 사업보고서를 이용해서 실적 공시 다음 날 주가의 당락을 예측한 프로젝트입니다. Sentimental word2vec을 이용한 word embedding, Label Propagation을 통한 unsupervised learning 문제를 supervised learning 문제로 변환을 통해 감성 사전을 구축하고 sentiment scoring을 진행하였습니다.   [App](https://churn-prediction-app.herokuapp.com/)  
